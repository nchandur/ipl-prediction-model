...
for index, row in tqdm(data.iterrows(), total=data.shape[0], desc="Calculating Elo", unit="row"):
...
data = data[["match_id", "date", "season", "team_1_id", "team_1", "team_1_pts", "team_1_elo", "team_2_id", "team_2", "team_2_pts", "team_2_elo", "winner_id", "winner"]]
